<template>
  <div class="flex flex-col px-20 mt-10 min-h-screen">
    <div class="flex flex-col w-max mx-auto gap-2">
      <p class="text-4xl text-center text-gray-800">Instalasi Bedah Sentral</p>
    ...
    async getData() {
      try {
        const data = await axios.get(
          "https://apiweb.pkusleman.com/api/layanan/kamar-operasi"
        );
        this.data = data.data;
