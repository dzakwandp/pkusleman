...
const imageClass = computed(() =>
  cn("h-full w-full scale-150 object-cover transition duration-300 duration-700 hover:brightness-50", props.imageClass),
);

const childrenClass = computed(() =>
  cn(
    "absolute bottom-4 left-4 z-40 transition-opacity duration-300",
    props.childrenClass,
  ),
);
