<template>
  <div
    ...
    <div class="mx-auto max-w-7xl px-4 pb-20 lg:px-10 md:px-8">
    ...
    <div ref="timelineRef" class="relative z-0 mx-auto max-w-7xl pb-40 -mt-20">
      <div
        ...
        <div
          className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-max">
          <div
          ...
          <h3
            className="hidden md:block text-xl md:pl-20 md:text-3xl font-semibold text-gray-800 dark:text-neutral-500 w-80">
            {{ item.label }}
          </h3>
        </div>
      ...
      <div
        ...
        <Motion
          ...
          class="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-primary-green from-0% via-yellow-500 via-10% to-transparent">
        </Motion>
      </div>
    </div>
  </div>
